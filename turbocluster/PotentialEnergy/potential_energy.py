...
from ..CudaKernels.potential_energy_kernels import (
    compute_potential_energy_coarse,
    compute_potential_energy_N2,
)
...
class PotentialEnergy(DataGpuInit):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if hasattr(smoothing_length, "unit"):
            assert (
                smoothing_length.unit == self.code_length.unit
    ...
    def _compute_potential_gpu(self, angle):
        ...
        compute_potential_energy_coarse[blocks_1d, threadsperblock](
            pos,
            mass,
            smoothing_length,
            tile_index,
        ...
        compute_potential_energy_N2[blocks_1d, threadsperblock](
            pos,
            mass,
            smoothing_length,
            tile_index,
