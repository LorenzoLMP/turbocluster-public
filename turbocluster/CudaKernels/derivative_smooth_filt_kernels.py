                        ...
                        if check_distance(ip_tile_x, ip_tile_y, ip_tile_z,
                            ...
                            for ip_other in range(start_index, start_index + n_particles):
                                ...
                                if dist < filter_window * filter_length:
                                    ...
                                    grad_x_VarRegister += variable[ip_other] * \
                                        grad_x * volume
                                    grad_y_VarRegister += variable[ip_other] * \
                                        grad_y * volume
                                    grad_z_VarRegister += variable[ip_other] * \
                                        grad_z * volume
                        ...
                        if check_distance(ip_tile_x, ip_tile_y, ip_tile_z,
                            ...
                            for ip_other in range(start_index, start_index + n_particles):
                                ...
                                if dist < filter_window * filter_length:
                                    ...
                                    grad_x_Vec_x_Reg += variable_x[ip_other] * \
                                        grad_x * volume
                                    grad_y_Vec_x_Reg += variable_x[ip_other] * \
                                        grad_y * volume
                                    grad_z_Vec_x_Reg += variable_x[ip_other] * \
                                        grad_z * volume

                                    grad_x_Vec_y_Reg += variable_y[ip_other] * \
                                        grad_x * volume
                                    grad_y_Vec_y_Reg += variable_y[ip_other] * \
                                        grad_y * volume
                                    grad_z_Vec_y_Reg += variable_y[ip_other] * \
                                        grad_z * volume

                                    grad_x_Vec_z_Reg += variable_z[ip_other] * \
                                        grad_x * volume
                                    grad_y_Vec_z_Reg += variable_z[ip_other] * \
                                        grad_y * volume
                                    grad_z_Vec_z_Reg += variable_z[ip_other] * \
                                        grad_z * volume
